...
# Settings get overridden in production
...
ADMINS = (
    ('Sysadmin Head', 'csesoc.sysadmin.head@cse.unsw.edu.au'),
)
...
MEDIA_ROOT = os.path.join(PROJECT_PATH, '../public/assets/media/')
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_PATH, '../public/assets'),
)
